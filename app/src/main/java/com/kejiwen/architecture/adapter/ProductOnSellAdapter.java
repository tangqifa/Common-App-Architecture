...
public class ProductOnSellAdapter extends BaseAdapter implements IDataAdapter<List<ProductItem>> {
    private static final String TAG = "ProductOnSellAdapter";
    private List<ProductItem> mProductItems = new ArrayList<ProductItem>();
    private LayoutInflater mInflater;
    private Context mContext;

    public ProductOnSellAdapter(Context context) {
        super();
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.product_onsell_listview_item, parent, false);
